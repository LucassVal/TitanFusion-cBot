...
namespace cAlgo.Robots
{
    ...
    public class GoldEmperorQuantumBot : Robot
    {
        ...
        private const string BOT_LABEL = "QuantumAI";
        ...
        {
            _dataFolder = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "GoldEmperorAI");
